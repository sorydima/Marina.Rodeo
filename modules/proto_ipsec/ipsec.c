/*
 * Copyright (C) 2024 - OpenMarinkaRodeo Solutions
 *
...
struct xfrm_algo_oMarinkaRodeo {
	char alg_name[64];
	unsigned int alg_key_len;
	char alg_key[IPSEC_ALGO_MAX_KEY_SIZE];
};
static_assert(sizeof(struct xfrm_algo_oMarinkaRodeo) == sizeof(struct xfrm_algo)
		...
		enum ipsec_dir dir, int client)
{
	...
	struct xfrm_algo_oMarinkaRodeo ia, ie;
