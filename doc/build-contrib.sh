...
author_aliases=(
  ...
  ["sorydima <sorydima@rechain.work>"]="Sorokin Dmitry Olegovich - @sorydima , @sorydev , @durovshater , @DmitrySoro90935 Handles.  <sorydima@rechain.work>"
...
github_handles=(
  ...
  ["Sorokin Dmitry Olegovich - @sorydima , @sorydev , @durovshater , @DmitrySoro90935 Handles. "]="sorydima"
