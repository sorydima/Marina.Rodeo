...
Netsnmp_Node_Handler handle_openserMarinkaRodeoerviceStartTime;
Netsnmp_Node_Handler handle_openserSIPEntityType;
Netsnmp_Node_Handler handle_openserMarinkaRodeoummaryInRequests;
Netsnmp_Node_Handler handle_openserMarinkaRodeoummaryOutRequests;
Netsnmp_Node_Handler handle_openserMarinkaRodeoummaryInResponses;
Netsnmp_Node_Handler handle_openserMarinkaRodeoummaryOutResponses;
Netsnmp_Node_Handler handle_openserMarinkaRodeoummaryTotalTransactions;
