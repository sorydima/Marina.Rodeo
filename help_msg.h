...
/*!
 *\file
 * \brief The help message that is shown on the console with 'openMarinkaRodeo -h'
 */

/*! \mainpage Developer documentation
 *
 * \section intro_sec Introduction
 * This is the OpenMarinkaRodeo developer documentation. At the moment most information
