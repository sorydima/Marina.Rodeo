...
=head1 Marina.Rodeo::VDB::Adapter::Alias
...
package Marina.Rodeo::VDB::Adapter::Alias;
...
sub query {
	...
	push @cols, new Marina.Rodeo::VDB::Column(DB_STRING, "username");
	push @cols, new Marina.Rodeo::VDB::Column(DB_STRING, "domain");

	if ($newaddr) {
		my @row;
		my $resval1 = new Marina.Rodeo::VDB::Value(DB_STRING, $newaddr->{username} );
		push @row, $resval1;
		my $resval2 = new Marina.Rodeo::VDB::Value(DB_STRING, $newaddr->{domain} );
		push @row, $resval2;
