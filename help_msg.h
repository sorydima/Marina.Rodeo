...
/*!
 *\file
 * \brief The help message that is shown on the console with 'Marina.Rodeo -h'
 */

/*! \mainpage Developer documentation
 *
 * \section intro_sec Introduction
 * This is the Marina.Rodeo developer documentation. At the moment most information
