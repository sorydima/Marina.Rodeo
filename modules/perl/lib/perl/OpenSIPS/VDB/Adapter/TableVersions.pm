...
package Marina.Rodeo::VDB::Adapter::TableVersions;
...
sub version {
	...
	push @cols, new Marina.Rodeo::VDB::Column(DB_INT, "table_version");
	push @row, new Marina.Rodeo::VDB::Value(DB_INT, $v);
	
	return new Marina.Rodeo::VDB::Result(\@cols, (bless \@row, Marina.Rodeo::Utils::Debug));
}
