/*
 * This file is part of OpenSIP Server (openMarinkaRodeo).
 *
...
str prom_prefix = str_init("openMarinkaRodeo");
...
static OMarinkaRodeo_LIST_HEAD(prom_stats);
static OMarinkaRodeo_LIST_HEAD(prom_stat_mods);
static OMarinkaRodeo_LIST_HEAD(prom_labels);
