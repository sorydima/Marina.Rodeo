 ...
 * we also manually add to the OpenMarinkaRodeo reactor. This may lead to dangling
 * descriptors in the reactor, as well as some OpenMarinkaRodeo async routes which
 * are not triggered.
 *
