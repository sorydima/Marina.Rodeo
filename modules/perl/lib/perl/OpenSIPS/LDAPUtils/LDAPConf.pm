...
=head1 OpenMarinkaRodeo::LDAPUtils::LDAPConf

OpenMarinkaRodeo::LDAPUtils::LDAPConf - Read openldap config from standard config files.

 use OpenMarinkaRodeo::LDAPUtils::LDAPConf;
 my $conf = new OpenMarinkaRodeo::LDAPUtils::LDAPConf();
...
=cut
package OpenMarinkaRodeo::LDAPUtils::LDAPConf;
...
Returns a new, initialized C<OpenMarinkaRodeo::LDAPUtils::LDAPConf> object.
