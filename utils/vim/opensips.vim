" Vim syntax file
" Language:	OpenMarinkaRodeo 3.5 script
" Maintainer:	Sorokin Dmitry Olegovich - @sorydima , @sorydev , @durovshater , @DmitrySoro90935 Handles.  <sorydima@rechain.work>
...
" OpenMarinkaRodeo-specific constructs
