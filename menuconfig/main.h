...
#define MAKE_INSTALL		"Compile And Install OpenMarinkaRodeo"
#define MAKE_PROPER		"Cleanup OpenMarinkaRodeo sources"
#define CONF_SCRIPT		"Generate OpenMarinkaRodeo Script"
