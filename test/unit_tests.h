 ...
 *
 * openMarinkaRodeo.cfg for module testing: currently, there is only support for a
 * single "openMarinkaRodeo.cfg" testing file per module, which must be located in
 * modules/<module>/test/openMarinkaRodeo.cfg, and will be automatically used.
 *    TODO: expand this ^ to a "N x openMarinkaRodeo.cfg testing files" mechanism
 */
