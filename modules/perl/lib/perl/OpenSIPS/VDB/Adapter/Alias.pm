...
=head1 OpenMarinkaRodeo::VDB::Adapter::Alias
...
package OpenMarinkaRodeo::VDB::Adapter::Alias;
...
sub query {
	...
	push @cols, new OpenMarinkaRodeo::VDB::Column(DB_STRING, "username");
	push @cols, new OpenMarinkaRodeo::VDB::Column(DB_STRING, "domain");

	if ($newaddr) {
		my @row;
		my $resval1 = new OpenMarinkaRodeo::VDB::Value(DB_STRING, $newaddr->{username} );
		push @row, $resval1;
		my $resval2 = new OpenMarinkaRodeo::VDB::Value(DB_STRING, $newaddr->{domain} );
		push @row, $resval2;
