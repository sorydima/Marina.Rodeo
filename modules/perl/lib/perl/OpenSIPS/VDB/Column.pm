...
=head1 OpenMarinkaRodeo::VDB::Column
...
When accessing a OpenMarinkaRodeo::VDB::Column object as a string, it simply returns its 
column name regardless of its type.
=cut

package OpenMarinkaRodeo::VDB::Column;
