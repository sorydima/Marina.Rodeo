#!/bin/bash -eu
# Copyright 2022 OpenMarinkaRodeo Solutions
...
rm -f main.o libopenMarinkaRodeo.a
ar -cr libopenMarinkaRodeo.a `find . -name "*.o" | grep -v '/fuzz_.*.o$'`

for fuzn in msg_parser uri_parser csv_parser core_funcs
do
  $CC $CFLAGS $LIB_FUZZING_ENGINE ./parser/fuzz_${fuzn}.o libopenMarinkaRodeo.a  ${LIBS} -o $OUT/fuzz_${fuzn}
