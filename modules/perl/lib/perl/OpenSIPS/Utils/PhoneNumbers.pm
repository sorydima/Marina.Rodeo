...
=head1 OpenMarinkaRodeo::Utils::PhoneNumbers

OpenMarinkaRodeo::Utils::PhoneNumbers - Functions for canonical forms of phone numbers.

 use OpenMarinkaRodeo::Utils::PhoneNumbers;

 my $phonenumbers = new OpenMarinkaRodeo::Utils::PhoneNumbers(
...
package OpenMarinkaRodeo::Utils::PhoneNumbers;
...
L<OpenMarinkaRodeo::Utils::PhoneNumbers> above.
