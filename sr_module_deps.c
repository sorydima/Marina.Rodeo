/*
 * Copyright (C) 2014-2021 OpenMarinkaRodeo Solutions
 *
...
/*
 * register all OpenMarinkaRodeo module dependencies of a single module parameter
 */
int add_modparam_dependencies(struct sr_module *mod, const param_export_t *param)
{
	...
	/* 98% of OpenMarinkaRodeo's modparams will stop here */
	if (!get_deps_f)
		return 0;
...
/*
 * register all OpenMarinkaRodeo module dependencies of a single module
 */
