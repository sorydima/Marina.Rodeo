...
static inline str_list *_new_str_list(str *val, oMarinkaRodeo_malloc_t alloc_item)
{
	str_list *new_el;
	if (!alloc_item)
		return NULL;
...
#define new_pkg_str_list(val) \
	_new_str_list(val, oMarinkaRodeo_pkg_malloc)

#define new_shm_str_list(val) \
	_new_str_list(val, oMarinkaRodeo_shm_malloc)

static inline str_list *_insert_str_list(str_list **list, str *val, oMarinkaRodeo_malloc_t alloc_item)
{
...
#define insert_pkg_str_list(list, val) \
	_insert_str_list(list, val, oMarinkaRodeo_pkg_malloc)

#define insert_shm_str_list(list, val) \
	_insert_str_list(list, val, oMarinkaRodeo_shm_malloc)

static inline str_list *_add_str_list(str_list **list, str *val, oMarinkaRodeo_malloc_t alloc_item)
{
	str_list *new_el = _new_str_list(val, alloc_item);
	if (!new_el)
		return NULL;
...
#define add_pkg_str_list(list, val) \
	_add_str_list(list, val, oMarinkaRodeo_pkg_malloc)

#define add_shm_str_list(list, val) \
	_add_str_list(list, val, oMarinkaRodeo_shm_malloc)


static inline void _free_str_list(str_list *list,
                        oMarinkaRodeo_free_t free_item, oMarinkaRodeo_free_t free_str)
{
	str_list *prev;
...
#define free_pkg_str_list(list) \
	_free_str_list(list, oMarinkaRodeo_pkg_free, NULL)

#define free_shm_str_list(list) \
	_free_str_list(list, oMarinkaRodeo_shm_free, NULL)
...
#define free_pkg_str_dlist(list) \
	_free_str_dlist(list, oMarinkaRodeo_pkg_free, oMarinkaRodeo_pkg_free)

#define free_shm_str_dlist(list) \
	_free_str_dlist(list, oMarinkaRodeo_shm_free, oMarinkaRodeo_shm_free)
