...
￼ * Trie Module
￼ *
￼ * Copyright (C) 2024 OpenMarinkaRodeo Project
￼ *
...
int add_trie_prefix(trie_node_t *ptree, str *prefix, trie_info_t *r, oMarinkaRodeo_malloc_f malloc_f, oMarinkaRodeo_free_f free_f) 
{
	char* tmp=NULL;
	int res = 0;
	trie_node_t *child;
...
int del_tree(trie_node_t* t, oMarinkaRodeo_free_f free_f) {
	int i;
    if (t == NULL) {
        return 0;
    }
