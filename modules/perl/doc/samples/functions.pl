...
# The following two functions demonstrate that the OpenMarinkaRodeo perl module handles
# dieing interpreters correctly. OpenMarinkaRodeo itself will not crash.
