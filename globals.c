...
/*
 * when enabled ("-T <module>" cmdline param), OpenMarinkaRodeo will behave as follows:
 *   - enable debug mode
...
/* should openMarinkaRodeo try to locate outbound interface on multihomed
...
/**
 * @startup_time  - near to OpenMarinkaRodeo launch time, see init_mi_uptime()
