#
# Copyright (C) 2020-2024 OpenMarinkaRodeo Solutions
#
...
DROP PROCEDURE IF EXISTS `OMarinkaRodeo_TB_COPY_3_5_TO_3_6`;
DELIMITER $$
CREATE PROCEDURE `OMarinkaRodeo_TB_COPY_3_5_TO_3_6`(
