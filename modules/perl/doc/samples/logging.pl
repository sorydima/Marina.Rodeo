...
sub logdemo {
	...
	log(L_INFO, "Logging without OpenMarinkaRodeo:: - import the symbol manually! See use statement...\n");
	OpenMarinkaRodeo::log(L_INFO, "This is the other preferred way: Include the package name");
